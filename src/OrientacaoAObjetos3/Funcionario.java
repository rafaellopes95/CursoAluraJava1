...
class Funcionario {
	...
	void exibeInformacoes() {
		...
		// System.out.println("Data de entrada no Banco: " + this.dataEntradaNoBanco);
		System.out.println("Data de entrada no Banco: " + this.dataEntradaNoBancoData.getFormatada());
		//System.out.println("Dia: " + this.dataEntradaNoBancoData.dia);
		//System.out.println("Mes: " + this.dataEntradaNoBancoData.mes);
		//System.out.println("Ano: " + this.dataEntradaNoBancoData.ano);
