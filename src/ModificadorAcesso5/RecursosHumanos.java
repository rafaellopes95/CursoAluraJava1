...
class RecursosHumanos {
	...
	public static void main(String[] args) {
		...
		func1.setDataEntradaNoBancoData(new Data());
		func1.getDataEntradaNoBancoData().setData(17, 8, 2015);
		...
		func2.setDataEntradaNoBancoData(new Data());
		func2.getDataEntradaNoBancoData().setData(20, 9, 2017);
